    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <h5>Get In Touch</h5>
                <p class="mb-4">Talk to us at the School of advanced programming by sending your queries to the form provided, calling us or emailing us. We will get back to you in lightning speeds.</p>
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="mb-0">Tumaini, Ongata Rongai</p>
                    </div>
                </div>
                <div class="d-flex align-items-center mb-3">
                    <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="mb-0">soapinstitute@onmail.com</p>
                    </div>
                </div>
            </div>
